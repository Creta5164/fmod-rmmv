...
- 5\. [플러그인 설정](#5-플러그인-설정)
  ...
  * 5.6. [이벤트 시간 상태 저장 여부](#56-이벤트-시간-상태-저장-여부)
  * 5.7. [시스템 음악(BGM)들](#57-시스템-음악bgm들)
  * 5.8. [시스템 음악 효과음(ME)들](#58-시스템-음악-효과음me들)
  * 5.9. [시스템 효과음(SE)들](#59-시스템-효과음se들)
- 6\. [사용법](#6-사용법)
